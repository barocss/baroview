const twelveUrls = '/demo.svg /demo.md /demo.pdf /demo.svg /demo.svg /demo.md /demo.pdf /demo.svg /demo.svg /demo.md /demo.pdf /demo.svg';

export default function App() {
  return (
    <div class="app">
      <h1>baroview (Solid)</h1>
      <p class="intro">All examples from the HTML app. Single, grid, gallery, and every slide variant.</p>
...
console.log(x);</pre></code>
      ...
      <section>
        <h2>Slides test (12 items, horizontal)</h2>
        <baro-view
          urls={twelveUrls}
          layout="gallery"
          gallery-style="slides"
